...
public final class Attendance {
    ...
    init(lessonNo: UInt64, day: Date, typeFull: String, typeShort: String, colorRgb: String) {
    ...
    static func new(attendance: SynergiaAttendances.AttendanceItem, types: SynergiaAttendanceTypes, colors: [String: String]) -> Self? {
        guard 
